package com.jbos.admin.application.service.im;

import com.jbos.admin.application.service.wf.ProcessCallback;
...
import com.jbos.admin.infrastructure.repository.im.MaterialBuyRepo;
...
public class MaterialBuyService {
    ...
    public ResponseResult handleMaterialBuyProcessTask(Map<String, Object> params) throws CamundaException {
        ...
        if("101".equals(processTask.getOpinion())){
            ...
            processTaskService.handleCompleteTask(processTask,variables,new ProcessCallback(){
                public void call(Map<String, String> data) {
                    Map<String, Object> parameterObject = new HashMap<>();
